...
public class PaddingArmor : ArmorCalculate
{
    
    public override float CalculateDamaged(eUnit_Attack_Property_States attackType, new_Unit_Data ArmorType, float attack_Dmg)  // 공격당했을 때 호출하는걸 전제로 함 
    {
